...
class LauncherEntrypointTests(unittest.TestCase):
    ...
    def test_launcher_declares_memory_command_dispatcher(self) -> None:
        ...
        self.assertIn('"mine"', launcher)
        self.assertIn('"candidates"', launcher)
        self.assertIn('"retention"', launcher)
        self.assertIn('"eval"', launcher)
        self.assertIn("memory_mining.py", launcher)
    ...
    def test_posix_launcher_declares_memory_command_dispatcher(self) -> None:
        ...
        self.assertIn("memory_mining.py", launcher)
        self.assertIn("memory_retention.py", launcher)
        self.assertIn("eval_replay.py", launcher)
        self.assertIn("mine)", launcher)
        self.assertIn("candidates)", launcher)
        self.assertIn("retention)", launcher)
        self.assertIn("eval|evals)", launcher)
        self.assertIn("candidates list|show|accept|reject|deprecate", launcher)
