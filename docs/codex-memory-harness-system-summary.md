...
```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\codex_bootstrap.py --cwd <PROJECT_ROOT> --doctor
```

初始化项目 memory 和 harness：

```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\codex_bootstrap.py --cwd <PROJECT_ROOT> --init-project
```
...
```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\hook_runner.py --event before_task --memory-scope project --memory-cwd <PROJECT_ROOT> --payload-file payload.json
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\hook_runner.py --event after_tool --memory-scope project --memory-cwd <PROJECT_ROOT> --payload-file payload.json
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\hook_runner.py --event before_response --memory-scope project --memory-cwd <PROJECT_ROOT> --payload-file payload.json
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\hook_runner.py --event on_task_complete --memory-scope project --memory-cwd <PROJECT_ROOT> --payload-file payload.json
```
...
```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\harness_controller.py --project-root <PROJECT_ROOT> start --task-file task.json
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\harness_controller.py --project-root <PROJECT_ROOT> checkpoint --task-id <TASK_ID> --result-file result.json
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\harness_controller.py --project-root <PROJECT_ROOT> complete --task-id <TASK_ID> --summary-file summary.md
```
...
```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\verification_runner.py --project-root <PROJECT_ROOT> list
```

运行默认 profile：

```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\verification_runner.py --project-root <PROJECT_ROOT> run --profile primary
```

绑定任务回写：

```powershell
py -X utf8 <USER_HOME>\plugins\codex-memory\scripts\verification_runner.py --project-root <PROJECT_ROOT> run --task-id <TASK_ID> --profile primary
```
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File <USER_HOME>\plugins\codex-memory\scripts\codexm.ps1 -DoctorOnly
```
