...
| A3 | 子目录级 `AGENTS.md` | 合理但只影响本仓库/发布包源码 | repo 内 `docs/AGENTS.md`、`tests/AGENTS.md`、`plugins/.../AGENTS.md` | 可做，但不等价于用户全局同步 |
...
| A7 | dispatch plan 对齐 custom agents | 合理 | 模板或显式 install 选项写入 `.codex/agents` / `~/.codex/agents` | 暂缓，避免默认侵入 |
